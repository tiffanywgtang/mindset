...
if ( ! function_exists( 'twd_setup' ) ) :
	...
	function twd_setup() {
		...
		register_nav_menus( array(
			...
			'social' => esc_html__( 'Social Menu Location', 'twd' ),
		) );
...
function twd_scripts() {
	wp_enqueue_style( 'twd-style', get_stylesheet_uri() );

	wp_enqueue_script( 'twd-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'twd-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
